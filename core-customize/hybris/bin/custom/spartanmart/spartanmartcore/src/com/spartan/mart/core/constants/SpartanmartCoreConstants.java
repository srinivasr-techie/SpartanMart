 ...
 */
package com.spartan.mart.core.constants;

/**
 * Global class for all SpartanmartCore constants. You can add global constants for your extension into this class.
 */
public final class SpartanmartCoreConstants extends GeneratedSpartanmartCoreConstants
{
	public static final String EXTENSIONNAME = "spartanmartcore";


	private SpartanmartCoreConstants()
	{
		//empty
	}
